...
public class D4 {
    ...
    static void sum(int x,int y){
        ...
        login(); // using fuction inside another
    ...
    //same function but with different argument (Overloading)
    ...
    // function been used in another function 
    ...
    public static void main(String[] args) {
        ...
        sum("ahmed",8);
        sum(8,"ahmed");
        int glob1 = 20; //this is not the global variable that exist in the following class 
        System.out.println(D4.glob1); // this is the global
